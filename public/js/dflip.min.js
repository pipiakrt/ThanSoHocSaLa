...
(function dFlip(DFLIP, $) {
    ...
    var defaults = (DFLIP.defaults = {
        ...
        text: {
            ...
            downloadPDFFile: "Tải Sách (File PDF)",
            gotoFirstPage: "Trang Trước",
            gotoLastPage: "Trang Sau",
            play: "Start AutoPlay",
    ...
    var createUI = function (container, object) {
        ...
        var next = (ui.next = $(html.div, { class: buttonClass + " " + uiClass + "-next " + options.icons["next"], title: isRTL ? options.text.previousPage : options.text.nextPage, html: "<span>" + options.text.nextPage + "</span>" }).on(
            "click",
            function () {
                object.next();
            }
        ...
        var play = $(html.div, { class: buttonClass + " " + uiClass + "-play " + options.icons["play"], title: options.text.play, html: "<span>" + options.text.play + "</span>" }).on("click", function () {
            var el = $(this);
        ...
        var zoomIn = (ui.zoomIn = $(html.div, { class: buttonClass + " " + uiClass + "-zoomin " + options.icons["zoomin"], title: options.text.zoomIn, html: "<span>" + options.text.zoomIn + "</span>" }).on("click", function () {
            object.zoom(1);
            ui.update();
            if (object.target.startPoint && object.target.pan) object.target.pan(object.target.startPoint);
        }));
        var zoomOut = (ui.zoomOut = $(html.div, { class: buttonClass + " " + uiClass + "-zoomout " + options.icons["zoomout"], title: options.text.zoomOut, html: "<span>" + options.text.zoomOut + "</span>" }).on("click", function () {
            object.zoom(-1);
            ui.update();
            if (object.target.startPoint && object.target.pan) object.target.pan(object.target.startPoint);
        }));
        zoom.append(zoomIn).append(zoomOut);
        var page = (ui.pageNumber = $(html.div, { class: buttonClass + " " + uiClass + "-page" })
            .on("change", function () {
        ...
        var help = $(html.div, { class: buttonClass + " " + uiClass + "-help " + options.icons["help"], title: options.text.toggleHelp, html: "<span>" + options.text.toggleHelp + "</span>" }).on("click", function () {});
        var sound = (ui.sound = $(html.div, { class: buttonClass + " " + uiClass + "-sound " + options.icons["sound"], title: options.text.toggleSound, html: "<span>" + options.text.toggleSound + "</span>" }).on("click", function () {
        ...
        var share = (ui.share = $(html.div, { class: buttonClass + " " + uiClass + "-share " + options.icons["share"], title: options.text.share, html: "<span>" + options.text.share + "</span>" }).on("click", function (event) {
        ...
        var pageModeButton = (ui.pageMode = $(html.div, { class: buttonClass + " " + uiClass + "-pagemode " + options.icons["singlepage"], html: "<span>" + options.text.singlePageMode + "</span>" }).on("click", function () {
            var el = $(this);
        ...
        var thumbnail = (ui.thumbnail = $(html.div, { class: buttonClass + " " + uiClass + "-thumbnail " + options.icons["thumbnail"], title: options.text.toggleThumbnails, html: "<span>" + options.text.toggleThumbnails + "</span>" }).on(
            "click",
            function () {
                var $this = $(this);
        ...
        var outline = (ui.outline = $(html.div, { class: buttonClass + " " + uiClass + "-outline " + options.icons["outline"], title: options.text.toggleOutline, html: "<span>" + options.text.toggleOutline + "</span>" }).on(
            "click",
            function () {
                var $this = $(this);
    ...
    function RegisterMockupObjects() {
        ...
        var BookPaper = (function (_super) {
            ...
            BookPaper.prototype.tween = function (oldAngle, newAngle) {
                ...
                page.first = { angle: oldAngle + diff / 4, angle2: oldAngle < 90 ? 90 : 90, stiff: page.originalStiff, index: (isRight && !isRTL) || (!isRight && isRTL) ? 1 : 0.25 };
                page.mid = { angle: oldAngle + (diff * 2) / 4, angle2: oldAngle < 90 ? 135 : 45, stiff: page.newStiffness, index: (isRight && !isRTL) || (!isRight && isRTL) ? 0.5 : 0.5 };
                page.mid2 = { angle: oldAngle + (diff * 3) / 4, angle2: oldAngle < 90 ? 180 : 0, stiff: page.newStiffness, index: (isRight && !isRTL) || (!isRight && isRTL) ? 0.25 : 1 };
            ...
            resize: function () {
                ...
                if (is3d) {
                    ...
                    if (stage.camera.position.z !== cameraZ && _this.pendingZoom == true) {
                        ...
                        _this.zoomTween = new TWEEN.Tween({ campos: stage.camera.position.z, otx: stage.orbitControl.target.x, oty: stage.orbitControl.target.y, otz: stage.orbitControl.target.z })
                            .delay(0)
                    ...
                    target.wrapper.css({ width: zoomFullWidth, height: zoomHeight, marginTop: containerHeight - zoomHeight - paddingHeight > 0 ? (containerHeight - paddingHeight - zoomHeight) / 2 : 0 });
    ...
    var ContentProvider = (function (_super) {
        ...
        ContentProvider.prototype.setupAnnotations = function (page, viewport, pageDiv, pageNumber) {
            ...
            return page.getAnnotations().then(function (annotationsData) {
                ...
                pdfjsLib.AnnotationLayer.render({ annotations: annotationsData, div: div[0], page: page, viewport: viewport, imageResourcesPath: defaults.imageResourcesPath, linkService: _this.linkService });
                ...
                if (_this.options.search == true) {
                    ...
                    page.getTextContent().then(function (textContent) {
                        var textLayer = new DFLIP.TextLayerBuilder({ textLayerDiv: div2[0], pageIndex: null, viewport: viewport.clone({ dontFlip: false }) });
    ...
    var BookCSS = (function (_super) {
        ...
        BookCSS.prototype.updatePage = function (pageNumber) {
            ...
            for (var _pageCount = 0; _pageCount < stackCount; _pageCount++) {
                ...
                page.oldDepth = page.depth;
                page.updateCSS({ display: page.visible == true ? "block" : "none", zIndex: 6 + (_pageCount < midPoint ? _pageCount - midPoint : midPoint - _pageCount), transform: "" });
    ...
    var FlipBook = (function (_super) {
        ...
        function FlipBook(container, source, parameters) {
            ...
            _this.container.css({ position: "relative", overflow: "hidden", backgroundColor: parameters.backgroundColor, backgroundImage: backgroundImage });
            ...
            if (webgl == true) {
                var updateMockupJs = function (callback) {
                    ...
                    if (window.MOCKUP == null) {
                        ...
                        if (typeof define === "function" && define.amd && window.requirejs) {
                            requirejs.config({ paths: { three: defaults.threejsSrc.replace(".js", "") }, shim: { three: { exports: "THREE" } } });
                ...
                updateMockupJs(function () {
                    ...
                    _this.contentProvider = new ContentProvider(
                        ...
                        function (contentProvider) {
                            var options = { pageCount: contentProvider.pageCount, stackCount: 6, segments: 20, width: contentProvider.bookSize.width, height: contentProvider.bookSize.height };
                ...
                _this.contentProvider = new ContentProvider(
                    _this.contentSource,
                    function (contentProvider) {
                        var options = { pageCount: contentProvider.pageCount, contentSourceType: contentProvider.contentSourceType };
        ...
        FlipBook.prototype.analytics = function (eventData) {
            if (this.options.enableAnalytics == true) {
                try {
                    ...
                    if (analyticsTag) {
                        analyticsTag("event", eventData.eventAction, { event_category: "Flipbook", event_label: eventLabel });
                    } else {
                        var analytics = window.ga || window.__gaTracker;
                        analytics("send", { hitType: "event", eventCategory: "Flipbook", eventAction: eventData.eventAction, eventLabel: eventLabel });
                    }
                } catch (e) {}
            }
        };
