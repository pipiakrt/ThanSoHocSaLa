...
<div class="gia-tri d-none d-md-block">
...
<div class="gia-tri d-block d-md-none">
    <div class="text-center">
        <h2 class="text-dark titleheader title-h1">GIÁ TRỊ THẦN SỐ HỌC</h2>
    </div>
    <div id="particles-js"></div>
        ...
        <div class="main-block">
            <div class="content-main">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="main-item text-center truc">
                            <img class="co-dinh chinh-giua z-10 mw-100" src="/img/kh/4.png" alt="Thần số học">
                            <img class="co-dinh quay-trai mw-100" src="/img/kh/2.png" alt="Thần số học">
                            <img class="co-dinh quay-phai mw-100" src="/img/kh/3.png" alt="Thần số học">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="main-item">
                            <div class="timeline right">
                                <div class="lime-height right"></div>
                                <div class="item-timeline">
                                    <div class="counter right">04</div>
                                    <div class="title">
                                        <h3>Yêu thương - Gắn kết</h3>
                                    </div>
                                    <div class="desc">
                                ...
                                <div class="item-timeline">
                                    <div class="counter indam right">05</div>
                                    <div class="title">
                                        <h3>Dự đoán con đường phát triển</h3>
                                    </div>
                                    <div class="desc">
                                ...
                                <div class="item-timeline">
                                    <div class="counter right">06</div>
                                    <div class="title">
                                        <h3>Năng lượng tích cực</h3>
                                    </div>
                                    <div class="desc">
