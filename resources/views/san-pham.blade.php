    ...
    <div class="container">
        <div class="text-center pt-5 pb-4" id="xemvideo">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <iframe class="mt-4 youtube-responsive" width="100%" height="411" src="https://www.youtube.com/embed/Q3ooMw9WsZA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="mt-4">
            <div class="container">
                <div class="row g-0">
                    ...
                    <div class="col-md-5">
                        <img class="mw-100 mh-100 mt-4 mt-md-0" src="https://w.ladicdn.com/s900x900/5da96e02ecb4f20339f4c96d/banner-problem-20210910104414.jpg" alt="">
                    </div>
                </div>
