                        ...
                        <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                <tr v-for="item in promotions.data" :key="'row' + item.id">
                                    ...
                                    <td>
                                        <router-link :to="'/sala-backend/khuyen-mai/' + item.id + '/chinh-sua'" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg" v-text="item.title"></router-link>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                <ul class="navi navi-hover">
                                                    <li class="navi-item">
                                                        ...
                                                        <router-link :to="'/sala-backend/khuyen-mai/' + item.id + '/chinh-sua'" class="navi-link">
                                                            <span class="navi-icon">
