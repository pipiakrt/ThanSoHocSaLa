      ...
      l = {
        ...
        collapse: function() {
          !1 !== l.eventTrigger("beforeCollapse") &&
            (KTUtil.slideUp(a.body, a.options.toggleSpeed, function() {
        ...
        expand: function() {
          !1 !== l.eventTrigger("beforeExpand") &&
            (KTUtil.slideDown(a.body, a.options.toggleSpeed, function() {
      ...
      l = {
        ...
        show: function() {
          "shown" != a.state &&
            ...
            a.attrCustom.length > 0 &&
              KTUtil.attr(i, "data-offcanvas-" + a.classCustom, "on"),
            (a.state = "shown"),
            a.options.overlay &&
        ...
        hide: function() {
          "hidden" != a.state &&
            ...
            a.attrCustom.length > 0 &&
              KTUtil.removeAttr(i, "data-offcanvas-" + a.attrCustom),
            (a.state = "hidden"),
        ...
        construct: function(t) {
          return (
            KTUtil.data(i).has("toggle")
              ...
              : (r.init(t), r.build(), KTUtil.data(i).set("toggle", n)),
            n
          );
        },
        init: function(t) {
          (n.element = i),
            ...
            "class" == n.options.targetToggleMode
              ? (n.state = KTUtil.hasClasses(n.target, n.targetState)
                  ? "on"
                  : "off")
              : (n.state = KTUtil.hasAttr(n.target, "data-" + n.targetState)
                  ? KTUtil.attr(n.target, "data-" + n.targetState)
                  : "off");
        },
        build: function() {
        ...
        toggleOn: function() {
          return (
            ...
            "class" == n.options.targetToggleMode
              ...
              : KTUtil.attr(n.target, "data-" + n.targetState, "on"),
        ...
        toggleOff: function() {
          return (
            ...
            "class" == n.options.targetToggleMode
              ...
              : KTUtil.removeAttr(n.target, "data-" + n.targetState),
        ...
        eventTrigger: function(t) {
          for (var e = 0; e < n.events.length; e++) {
            ...
            if (a.name == t) {
              ...
              if (0 == a.fired)
                return (n.events[e].fired = !0), a.handler.call(this, n);
            }
          }
        },
          ...
          !1 !==
            (n =
              e.height instanceof Function
                ? e.height.call()
                : !0 === KTUtil.isMobileDevice() && e.mobileHeight
          ...
          a.options.navigation &&
            (KTUtil.addEvent(a.btnNext, "click", function(t) {
              t.preventDefault(),
                ...
                !1 !== o.eventTrigger("change") && o.goTo(o.getNextStep());
            }),
            KTUtil.addEvent(a.btnPrev, "click", function(t) {
              t.preventDefault(),
                o.setNewStep(o.getPrevStep()),
                !1 !== o.eventTrigger("change") && o.goTo(o.getPrevStep());
            }),
            ...
            !0 === a.options.clickableSteps &&
              KTUtil.on(n, '[data-wizard-type="step"]', "click", function() {
                ...
                t !== a.currentStep &&
                  (o.setNewStep(t),
                  !1 !== o.eventTrigger("change") && o.goTo(t));
              });
        },
        goTo: function(t) {
          if (!0 !== a.stopped) {
      ...
      if (0 !== t(this).length) {
        ...
        var l = {
            ...
            null === e.data.source && (l.extractTable(), (n = !0)),
              ...
              ("remote" !== e.data.type && "local" !== e.data.type) ||
                ...
                "local" === e.data.type &&
                  ...
                  (o.dataSet = o.originalDataSet = l.dataMapCallback(
                    e.data.source
                  )),
                l.dataRender()),
              n &&
          ...
          dropdownFix: function() {
            var e;
            t("body")
              .on("show.bs.dropdown", ".datatable .datatable-body", function(
                a
              ) {
              ...
              .on("hide.bs.dropdown", ".datatable .datatable-body", function(
                a
              ) {
                void 0 !== e &&
          ...
          setupDOM: function(e) {
            t(e)
              .find("> thead")
              .addClass("datatable-head"),
              t(e)
                .find("> tbody")
                .addClass("datatable-body"),
              t(e)
                .find("> tfoot")
                .addClass("datatable-foot"),
              t(e)
                .find("tr")
                .addClass("datatable-row"),
              t(e)
          ...
          updateTableComponents: function() {
            (o.tableHead = t(o.table)
              .children("thead")
              .get(0)),
              (o.tableBody = t(o.table)
                .children("tbody")
                .get(0)),
              (o.tableFoot = t(o.table)
                .children("tfoot")
                .get(0));
          },
          getData: function() {
          ...
          paging: function(e, n) {
            var i = {
                  ...
                  t("<li/>")
                    ...
                    l.getOption("toolbar.items.info") &&
                      (i.pagerLayout.info = t("<div/>")
                        .addClass("datatable-pager-info my-2 mb-sm-0")
                        .append(
                          t("<span/>").addClass("datatable-pager-detail")
                        )),
              ...
              paste: function() {
                t.each(t.unique(l.getOption("toolbar.placement")), function(
                  e,
                  a
                ) {
                  "bottom" === a &&
          ...
          columnHide: function() {
            ...
            t.each(i.columns, function(n, i) {
              if (void 0 !== i.responsive || void 0 !== i.visible) {
                var r = i.field,
                  s = t.grep(t(o.table).find(".datatable-cell"), function(
                    e,
                    a
                  ) {
              ...
              t(o.table)
                ...
                t(o.tableBody).each(function() {
                  for (
                    ...
                    n < r && r - n > l.cellOffset && a < i.columns.length;
            ...
            var e = {
              ...
              setIcon: function() {
                ...
                if (!t.isEmptyObject(e)) {
                  ...
                  if (
                    void 0 !== a &&
                    !(
                      (void 0 !== a.sortable && !1 === a.sortable) ||
                      (void 0 !== a.selector && !0 === a.selector)
                    )
                  ) {
                    var n = t(o.tableHead)
              ...
              sortClick: function(n) {
                ...
                if (
                  ...
                  (void 0 === d.selector || !0 !== d.selector) &&
                  (t(o.tableHead)
                    .find("th")
                  ...
                  if (e == t(n).text()) {
                    var i =
                      t(n)
                        ...
                        .index() + 1;
                    return (
                      (o.API.record = o.API.value = l.getOneRow(
                        o.tableBody,
                        i
                      )),
                      o
          ...
          rows: function(e) {
            return (
              l.isLocked()
                ? (l.nodeTr = l.recentNode = t(o.tableBody)
                    .find(e)
          ...
          column: function(e) {
            return (
              (l.nodeCols = l.recentNode = t(o.tableBody).find(
          ...
          columns: function(e) {
            ...
            return (
              n.length > 0
                ...
                : (l.nodeCols = l.recentNode = t(a)
                    .find(e)
                    .filter(".datatable-cell")),
              o
            );
          },
          cell: function(e) {
          ...
          visible: function(e) {
            if (t(l.recentNode.length)) {
              ...
              if (l.recentNode === l.nodeCols) {
                ...
                if (l.isLocked()) {
                  var o = t(l.recentNode).closest(".datatable-lock-scroll")
                    .length;
                  o
                    ? (n += a.left.length + 1)
          ...
          init: function() {
            n.selectorEnabled() &&
              ...
              t(e).on("datatable-on-check", function(t, a) {
                ...
                var i = {};
                (i.selectedRows = n.selectedRows.filter(n.unique)),
                  (i.unselectedRows = n.unselectedRows.filter(n.unique)),
            ...
            t(e.tableHead)
              ...
              .click(function(i) {
                if (
                  ...
                  var o = {};
                  (o.selectedRows = n.selectedRows.filter(n.unique)),
...
KTUtil.isRTL() &&
  ...
  KTUtil.ready(function() {
    void 0 !== KTLayoutHeader &&
      ...
      void 0 !== KTLayoutAsideMenu && KTLayoutAsideMenu.init("kt_aside_menu"),
      void 0 !== KTLayoutSubheader && KTLayoutSubheader.init("kt_subheader"),
      void 0 !== KTLayoutContent && KTLayoutContent.init("kt_content"),
      void 0 !== KTLayoutFooter && KTLayoutFooter.init("kt_footer"),
      void 0 !== KTLayoutScrolltop && KTLayoutScrolltop.init("kt_scrolltop"),
      void 0 !== KTLayoutStickyCard &&
        KTLayoutStickyCard.init("kt_page_sticky_card"),
      void 0 !== KTLayoutStretchedCard &&
        KTLayoutStretchedCard.init("kt_page_stretched_card"),
      void 0 !== KTLayoutExamples && KTLayoutExamples.init(),
      void 0 !== KTLayoutDemoPanel && KTLayoutDemoPanel.init("kt_demo_panel"),
      ...
      void 0 !== KTLayoutQuickUser && KTLayoutQuickUser.init("kt_quick_user"),
  ...
  return {
    init: function(n) {
      ...
      ((t = KTUtil.getBody()), (e = KTUtil.getById(n))) &&
        ...
        "1" === KTUtil.attr(e, "data-menu-scroll") &&
          (i = {
            ...
            height: function() {
              ...
              return (
                KTUtil.isBreakpointUp("lg") && (t -= KTLayoutBrand.getHeight()),
                t -
        ...
        (a = new KTMenu(e, {
          scroll: i,
          submenu: { desktop: o, tablet: "accordion", mobile: "accordion" },
        ...
        KTUtil.hasClass(t, "aside-fixed") &&
          ...
          KTUtil.addEvent(KTLayoutAside.getElement(), "mouseleave", function(
            e
          ) {
            e.preventDefault(),
              !1 !== KTUtil.isBreakpointUp("lg") &&
  ...
  return {
    ...
    getHeight: function() {
      return (
        ...
        (e -= KTLayoutSubheader.getHeight()) - KTLayoutFooter.getHeight()
      );
      var e;
    },
    getElement: function() {
          ...
          height: function() {
            ...
            return KTUtil.isBreakpointDown("lg")
              ? KTUtil.hasAttr(a, "data-mobile-height")
                ...
                : 400
              : KTUtil.isBreakpointUp("lg") && KTUtil.hasAttr(a, "data-height")
        ...
        ("keenthemes.com" != encodeURI(window.location.hostname) &&
          ...
          setTimeout(function() {
            if (!KTCookie.getCookie("kt_app_chat_shown")) {
              ...
              KTCookie.setCookie("kt_app_chat_shown", 1, { expires: t }),
          ...
          KTUtil.scrollInit(n, {
            ...
            height: function() {
              ...
              return (
                ...
                (o -= parseInt(KTUtil.css(t, "paddingBottom"))) - 2
              );
            },
          });
        })();
...
var KTLayoutSearch = function() {
  var t,
    ...
    v = function() {
      if (d && s === a.value)
        return g(), KTUtil.addClass(t, f), m(), void KTUtil.scrollUpdate(i);
      (s = a.value),
